...
public interface ProfileIdService {
    ...
    Optional<ProfileIdDTO> addProfileId(String entityId, String profileId) throws AppException;
    ...
    Optional<ProfileIdDTO> updateProfileId(String entityId, String profileId) throws AppException;
}
